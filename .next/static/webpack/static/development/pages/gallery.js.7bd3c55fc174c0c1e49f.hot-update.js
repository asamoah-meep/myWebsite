...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Dropdown, [{
    ...
    value: function componentDidMount() {
      if (this.state.test) {
        this.model.addChild(this.state.test.renderer.domElement);
...
/* harmony import */ var _public_model__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../public/model */ "./public/model.js");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Gallery, [{
    ...
    value: function componentDidMount() {
      var models = this.items.map(function (ele) {
        return new _public_model__WEBPACK_IMPORTED_MODULE_12__["default"](ele + '.gltf', false);
      });
      var index = 0;
      console.log(this);
      ...
      try {
        for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0___default()(this.items), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          this[modelName].addChild(models[index]); // models[index++].load();
        }
      } catch (err) {
    ...
    value: function render() {
      ...
      //         <Dropdown key={ele} title={ele}><div ref={ref=>(this[ele] = ref)}/><p>!</p></Dropdown>
      //     );
      this.models = this.items.map(function (ele) {
        return __jsx(components_dropdown_js__WEBPACK_IMPORTED_MODULE_11__["default"], {
          key: ele,
          ref: function ref(_ref) {
      ...
      // console.log(containers[0].appendChild);
...
//# sourceMappingURL=gallery.js.7bd3c55fc174c0c1e49f.hot-update.js.map